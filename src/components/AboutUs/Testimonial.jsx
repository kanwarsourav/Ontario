...
export default function Testimonial() {
  return (
    <>
      <div>
        <div className='max-w-7xl mx-auto px-4 md:px-12 py-10 gap-4 md:gap-0 flex justify-center md:justify-between items-center flex-wrap md:flex-nowrap'>
          <div className='flex flex-col justify-center items-center md:items-start lg:pl-14'>
            <h4 className="flex gap-1 text-[#E64E37] text-lg font-medium justify-start "> 
              <div>
          ...
          <div className='flex justify-center gap-5 flex-wrap md:flex-nowrap'>
            <div className="w-[80%] md:w-[40%] bg-white  border-gray-200 rounded-2xl shadow-md p-6  transform transition-transform duration-300 hover:scale-105 h-full">
            ...
            <div className="bg-white w-[80%] md:w-[40%] border-gray-200 rounded-2xl shadow-md p-6  transform transition-transform duration-300 hover:scale-105 h-full">
