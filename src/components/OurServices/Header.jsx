    ...
    return (
        <>
            <div className=' bg-cover bg-center h-40 w-full bg-[#002768] flex flex-col justify-center '
                ...
                <h2 className='flex justify-center items-center font-bold text-5xl text-white'>Our Services</h2>
                <h5 className='flex justify-center items-center font-bold text-sm text-white'>HOME | Our Services</h5>
            </div >
