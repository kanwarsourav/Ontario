...
export default function BusinessVisa() {
    ...
    return (
        <>
            ...
            >
                <h2 className='font-bold text-4xl md:text-5xl text-white'>Business visa Processing</h2>
                <h5 className='font-bold text-sm text-white'>HOME | Business Visa Processing</h5>
            </div>
