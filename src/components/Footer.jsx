            ...
            <div class=" bg-cover bg-center h-full w-full  bg-[#002768] "
                ...
                <div className='max-w-7xl mx-auto px-4 md:px-14 py-10 flex-wrap lg:flex-nowrap   flex justify-between'>
                    <div className='flex flex-col gap-6 lg:w-[24%]'>
                        ...
                        <p className=' text-white w-[75%]'>Open doors to international opportunities and grow your career without borders.</p>
                        <div className='flex gap-4 '>
                            <img src={circlefb} alt="" className='cursor-pointer transform transition-transform duration-300 hover:scale-115'/>
                            <img src={circleinsta} alt="" className='cursor-pointer transform transition-transform duration-300 hover:scale-115'/>
                            <img src={circlein} alt="" className='cursor-pointer transform transition-transform duration-300 hover:scale-115' />
                        </div>
                    </div>
                    <div className='lg:w-[17%]'>
                        <h3 className='text-white font-semibold text-[22px]'>Quick Links</h3>
                        <ul className='flex flex-col gap-2 mt-4'>
                           <li className="text-white flex gap-1 text-[18px] items-center cursor-pointer">
                                <div>
                    ...
                    <div className='lg:w-[27%]'>
                        ...
                        <p className='text-white w-[90%] mt-2'>Enter your email address to get latest updates and offers from us.</p>
                        <input type="email" placeholder="Enter your email" class="px-1 py-1 w-full sm:w-60 mt-2  border-2  border-[#FBDFDB] bg-[#FFF5F3] text-[#002768]  text-start">
                        </input>
                    </div>
                </div>
            </div>
